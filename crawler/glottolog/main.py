...
for language in languages:
    ...
    create_lingua = requests.post(f"{HOST}/lingua", data=json.dumps({'nome': language_name, 'id_tronco': id_tronco}), headers={'content-type': 'application/json'})
    print(create_lingua.json())
